    ...
    return (
        <div className={NewClass}>
            ...
            <ul className={scrollPosition > 0 ? 'hidden md:flex text-black' : 'hidden md:flex'}>
                ...
                <li className='p-4 hover:text-yellow-300'><Link to='/company'>Company</Link></li>
                <li className='p-4 hover:text-yellow-300'><Link to='/product'>Product</Link></li>
                <li className='p-4 hover:text-yellow-300'><Link to="/about">About</Link></li>
                <li className='p-4 hover:text-yellow-300'><Link to="/contact">Contact</Link></li>
            </ul>
